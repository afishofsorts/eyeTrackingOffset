...
####################################################################
# PLOTS DATA SPREAD TO INVESTIGATE DIFFERENCES WITH SHRUNK DATA    #
####################################################################
...
for i in range(len(dir_list)-1):
    ...
    plt.title(sum(n[0][:4])) # number of data points below 0 x value
...
for i in range(len(rctListTS)):
    ...
    plt.title(sum(n[0][:4])) # number of data points below 0 x value, are these being shrunk?
